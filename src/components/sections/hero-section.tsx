...
export function HeroSection() {
  return (
    <section
      id="top"
      className="relative overflow-hidden pb-16 pt-[120px] md:pb-24 md:pt-[168px]"
      style={{
        background:
    ...
    >
      <div className="container-shell relative z-[2] grid items-center gap-10 lg:grid-cols-[minmax(420px,560px)_1fr] lg:gap-14">
        <div>
          <div className="mb-6 inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-[var(--color-border-strong)] bg-white/[0.03] px-3.5 py-1.5">
          ...
          <h1 className="display-title mb-5 text-[38px] leading-[1.08] sm:text-[46px] md:text-[54px] lg:text-[64px]">
            {hero.headingLead}{" "}
            <span
          ...
          <p className="lead-copy mb-3.5 max-w-[520px] text-[15px] sm:text-[16.5px]">{hero.paragraph}</p>
          <p className="mb-8 max-w-[500px] text-[15px] leading-[1.6] text-[var(--color-text-muted)]">{hero.secondary}</p>
